...
D:\agent\4\_work\19\s\common\node_modules\.bin\gulp clean
D:\agent\4\_work\19\s\common\node_modules\.bin\gulp --no-color --production
[00:10:12] Using gulpfile D:\agent\4\_work\19\s\packages\office-ui-fabric-react\gulpfile.js
[00:10:12] Starting gulp
[00:10:12] Starting 'default'...
[00:10:12] Starting subtask 'sass'...
[00:10:16] Finished subtask 'sass' after 4.35 s
[00:10:16] Starting subtask 'tslint'...
[00:10:16] Starting subtask 'typescript'...
[00:10:16] [typescript] TypeScript version: 2.1.6
[00:10:16] Starting subtask 'text'...
[00:10:16] Starting subtask 'api-extractor'...
[00:10:16] Finished subtask 'api-extractor' after 697 μs
[00:10:19] Finished subtask 'text' after 3.05 s
[00:10:56] Finished subtask 'tslint' after 40 s
[00:10:59] Finished subtask 'typescript' after 43 s
[00:10:59] Starting subtask 'post-copy'...
[00:10:59] Finished subtask 'post-copy' after 439 ms
[00:10:59] Starting subtask 'webpack'...
Webpack Bundle Analyzer saved report to D:\agent\4\_work\19\s\packages\office-ui-fabric-react\dist\office-ui-fabric-react.stats.html
[00:11:18] Finished subtask 'webpack' after 19 s
[00:11:18] Starting subtask 'karma'...
Webpack Bundle Analyzer saved report to D:\agent\4\_work\19\s\packages\office-ui-fabric-react\dist\office-ui-fabric-react.stats.html
09 03 2017 00:11:29.895:WARN [karma]: Port 9876 in use
09 03 2017 00:11:29.897:INFO [karma]: Karma v0.13.22 server started at http://localhost:9877/
09 03 2017 00:11:29.902:INFO [launcher]: Starting browser PhantomJS
09 03 2017 00:11:31.514:INFO [PhantomJS 2.1.1 (Windows 8 0.0.0)]: Connected on socket A8_BvYZYw8XTmXoSAAAA with id 35794233
...
LOG: 'A'
  ...
  CommandBar
    ...
    √ keeps menu open after update if item is still present
    √ closes menu after update if item is not longer present
    √ updates menu after update if item is still present
  ContextualMenu
    ...
    √ correctly focuses the first element
    √ will not focus the first element when shouldFocusOnMount is false
  Dialog
    √ Fires dismissed after closing
  Dropdown
    √ Can flip between enabled and disabled.
    √ Renders no selected item in default case
    √ Renders a selected item in uncontrolled case
    √ Renders a selected item in controlled case
    √ Can change items in uncontrolled case
  Facepile
    Render personas and buttons
      √ renders with only add button if no personas found and addButtonProps are not null
      √ renders chevron overflow button if overflowButtonProps are not null and OverflowButtonType equals downArrow
      √ renders more overflow button if overflowButtonProps are not null as OverflowButtonType equals more
      √ renders without descriptive overflow button if overflowButtonProps are not null and maximum personas are not exceeded
      √ renders with descriptive overflow button if overflowButtonProps are not null and maximum personas are exceeded
      √ renders no more than maximum allowed personas
      √ persona is clickable if onClick property is set
      √ personas and buttons render default size if not specified
      √ personas and buttons render specified size
  FocusZone
  ...
  Image
    ...
    √ allows onError events to be attached
  Label
    √ renders a label
  Layer
  ...
  MessageBar
    dismiss
      single-line
        √ is present when onDismiss exists
        √ is not present when onDismiss is missing
      multi-line
        √ is present when onDismiss exists
        √ is not present when onDismiss is missing
  Panel
    √ Fires the correct events when closing
  Persona
    initials and colors
  ...
  TextField
    ...
    √ should call onChanged handler for input change
    error message
      ...
      √ should not trigger validation on component mount
  Toggle
    √ renders a label
...
Finished in 3.36 secs / 2.201 secs

SUMMARY:
√ 169 tests completed
[00:11:39] Finished subtask 'karma' after 21 s
[00:11:39] Finished 'default' after 1.45 min
[00:11:40] ==================[ Finished ]==================
[00:11:40] Project office-ui-fabric-react version: 1.14.2
[00:11:40] Build tools version: 2.4.0
[00:11:40] Node version: v6.9.1
[00:11:40] Total duration: 1.48 min
